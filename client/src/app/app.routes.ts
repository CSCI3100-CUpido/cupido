...
import { MatchExplorerComponent } from './components/match/match-explorer.component';
...
export const routes: Routes = [
  ...
  // 验证码路由
  { path: 'auth/verification-code', component: VerificationCodeComponent, canActivate: [authGuard] },
  ...
  { path: 'match/explore', component: MatchExplorerComponent, canActivate: [authGuard] },
